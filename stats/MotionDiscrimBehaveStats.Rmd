...
followuptests2 <-function(behavedata, formula){
  ...
  cat('\nSpace')
  print(ttestBF(formula = formula, data = datuse[datuse['AttentionTrained']=="Space",]))
  cat('\nFeat')
  print(ttestBF(formula = formula, data = datuse[datuse['AttentionTrained']=="Feature",]))
...
followuptests2(behavedata, Sensitivity ~ Testday)
...
followuptests2(behavedata, RT ~ Testday)
...
followuptests2(behavedata, correct ~ Testday)
...
followuptests2(behavedata, Criterion ~ Testday)
